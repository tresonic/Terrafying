...
public class Recipe {
	...
	public static void registerRecipes() {
		...
		//Items Iron	
		registerRecipe(c++, RecipeType.CRAFTING, new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Item.getItemByName("iron"), 2), new ItemStack(Item.getItemByName("oakwoodplanks"), 2), new ItemStack(Item.getItemByName("coal"), 2))), new ItemStack(Item.getItemByName("ironsword"), 1));
		registerRecipe(c++, RecipeType.CRAFTING, new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Item.getItemByName("iron"), 2), new ItemStack(Item.getItemByName("oakwoodplanks"), 2), new ItemStack(Item.getItemByName("coal"), 2))), new ItemStack(Item.getItemByName("ironhoe"), 1));
		registerRecipe(c++, RecipeType.CRAFTING, new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Item.getItemByName("iron"), 3), new ItemStack(Item.getItemByName("oakwoodplanks"), 2), new ItemStack(Item.getItemByName("coal"), 3))), new ItemStack(Item.getItemByName("ironpickaxe"), 1));
		registerRecipe(c++, RecipeType.CRAFTING, new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Item.getItemByName("iron"), 3), new ItemStack(Item.getItemByName("oakwoodplanks"), 2), new ItemStack(Item.getItemByName("coal"), 3))), new ItemStack(Item.getItemByName("ironaxe"), 1));
		//Items Diamond
		registerRecipe(c++, RecipeType.CRAFTING, new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Item.getItemByName("diamond"), 2), new ItemStack(Item.getItemByName("oakwoodplanks"), 2), new ItemStack(Item.getItemByName("coal"), 2))), new ItemStack(Item.getItemByName("diamondsword"), 1));
		registerRecipe(c++, RecipeType.CRAFTING, new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Item.getItemByName("diamond"), 2), new ItemStack(Item.getItemByName("oakwoodplanks"), 2), new ItemStack(Item.getItemByName("coal"), 2))), new ItemStack(Item.getItemByName("diamondhoe"), 1));
		registerRecipe(c++, RecipeType.CRAFTING, new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Item.getItemByName("diamond"), 3), new ItemStack(Item.getItemByName("oakwoodplanks"), 2), new ItemStack(Item.getItemByName("coal"), 3))), new ItemStack(Item.getItemByName("diamondpickaxe"), 1));
