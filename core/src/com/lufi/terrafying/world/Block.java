...
public class Block {
	...
	public static void registerBlocks() {
		...
		registerBlock(c++, 2.0f, MineType.STONELIKE, 0, true, true, true, false, "stone");
		...
		registerBlock(c++, 2.0f, MineType.STONELIKE, 0, true, true, true, false, "coal");
		registerBlock(c++, 3.0f, MineType.STONELIKE, 0, true, true, true, false, "iron");
		registerBlock(c++, 3.0f, MineType.STONELIKE, 0, true, true, true, false, "gold");
		registerBlock(c++, 4.0f, MineType.STONELIKE, 0, true, true, true, false, "ruby");
		registerBlock(c++, 4.0f, MineType.STONELIKE, 0, true, true, true, false, "uranium");
		registerBlock(c++, 3.0f, MineType.STONELIKE, 0, true, true, true, false, "copper");
		registerBlock(c++, 4.0f, MineType.STONELIKE, 0, true, true, true, false, "diamond");
		registerBlock(c++, 2.0f, MineType.STONELIKE, 0, true, true, true, false, "cobble");
		registerBlock(c++, 1.0f, MineType.STONELIKE, 0, true, true, true, false, "bricks");
		registerBlock(c++, 1.5f, MineType.STONELIKE, 0, true, true, true, false, "blueclay");
		registerBlock(c++, 1.5f, MineType.STONELIKE, 0, true, true, true, false, "yellowclay");
		registerBlock(c++, 1.5f, MineType.STONELIKE, 0, true, true, true, false, "greenclay");
		...
		registerBlock(c++, 0.5f, MineType.NONE, 0, true, true, true, false, "oakwoodleaves");
